...
[xk1,iterations1] = levenberg_marquardt(xk,epsilon,f,"const",0.3);
figure(1) 
fcontour(f);
hold on;
...
%
xk = [xinit;yinit];
[xk2,iterations2] = levenberg_marquardt(xk,epsilon,f,"min",0.3);
figure(2)
fcontour(f);
hold on;
...
xk = [xinit;yinit];
[xk3,iterations3] = levenberg_marquardt(xk,epsilon,f,"armijo",0.3);
figure(3)
fcontour(f);
hold on;
